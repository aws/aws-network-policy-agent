...
require (
	...
	// TODO: remove once google.golang.org/protobuf releases a version with Go 1.26 DCE fixes.
	// This is the same pre-release commit that upstream Kubernetes uses
	// (kubernetes/kubernetes#137451) and includes fixes for the MethodByName("Methods")
	// regression that breaks dead code elimination in Go 1.26.
