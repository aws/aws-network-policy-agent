...
require (
	...
	github.com/aws/amazon-vpc-resource-controller-k8s v1.7.15 // indirect
	...
	k8s.io/apiextensions-apiserver v0.35.0-alpha.2 // indirect
...
replace github.com/aws/aws-ebpf-sdk-go => github.com/jaydeokar/aws-ebpf-sdk-go v0.0.0-20251121055151-9f836ba1aa92
