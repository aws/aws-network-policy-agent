...
POLICY_SETTLE_SECONDS=${NPA_SCALE_POLICY_SETTLE_SECONDS:-10}
SHORT_LIVED_TARGETS=${NPA_SCALE_SHORT_LIVED_TARGETS:-100}
SHORT_LIVED_ROUNDS=${NPA_SCALE_SHORT_LIVED_ROUNDS:-20}
SHORT_LIVED_INTERVAL_SECONDS=${NPA_SCALE_SHORT_LIVED_INTERVAL_SECONDS:-60}
...
WORKLOAD_SHORT_LIVED_LIFETIME_SECONDS=$SHORT_LIVED_LIFETIME_SECONDS
...
npa_require_positive_integer NPA_SCALE_POLICY_SETTLE_SECONDS "$POLICY_SETTLE_SECONDS"
...
npa_apply_short_lived_policies "$NAMESPACE"
