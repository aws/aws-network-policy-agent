...
func TestGetPodIdentifierFromBPFPinPath(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "Ingress Pinpath with pod name containing dots",
			args: args{
		...
		{
			name: "Egress Pinpath with pod name containing dots",
			args: args{
...
func TestPodIdentifierRoundTrip(t *testing.T) {
	type args struct {
		podName      string
		podNamespace string
		direction    string
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				podName:      "ylinux.app-75f4596489-g4x8c",
