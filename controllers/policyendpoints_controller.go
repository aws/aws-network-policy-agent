...
func NewPolicyEndpointsReconciler(k8sClient client.Client, log logr.Logger,
	enablePolicyEventLogs, enableCloudWatchLogs bool, enableIPv6 bool, enableNetworkPolicy bool, conntrackTTL int, conntrackTableSize int, runAsSystemProcess bool) (*PolicyEndpointsReconciler, error) {
	...
	if enableNetworkPolicy {
		r.ebpfClient, err = ebpf.NewBpfClient(&r.policyEndpointeBPFContext, r.nodeIP,
			enablePolicyEventLogs, enableCloudWatchLogs, enableIPv6, conntrackTTL, conntrackTableSize, runAsSystemProcess)
